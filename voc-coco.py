...
val_files_num = 1
test_files_num = 1
voc_annotations = '././IP102/Detection/VOC2007/Annotationsnew/'  #remember to modify the path
...
voc_images = os.path.join(main_path, os.path.join(coco_name+'/', 'JPEGImages/'))
